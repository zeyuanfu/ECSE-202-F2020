...
public class ppSimParams {
	...
	static final double ppAgentXgain = 1.5; 											// Vx gain on paddle hit
	static final double ppAgentYgain = 1.5; 											// Vy gain on paddle hit
	...
	static final double KEmax = 0.05;													// Maximum kinetic energy

	// 3. Parameters used by the ppSimPaddleAgent class
